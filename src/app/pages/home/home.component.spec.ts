...
describe('HomeComponent', () => {
  ...
  describe('triggerTyping', () => {
    ...
    beforeEach(() => {
      ...
      spyOnTypeText = spyOn(component as any, 'typeText').and.resolveTo(
        undefined
      );
    ...
    it('should call typeText with the translated text', fakeAsync(() => {
      ...
      tick(); // Avance le temps pour la promesse de get() et typeText()
      flush();
